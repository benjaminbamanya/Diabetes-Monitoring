...
public class RemindersAdapter extends ArrayAdapter<Reminder> {
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup parent) {
        ...
        LinearLayout rootView = v.findViewById(R.id.activity_reminders_root_view);
        TextView timeTextView = v.findViewById(R.id.activity_reminders_item_time);
        TextView labelTextView = v.findViewById(R.id.activity_reminders_label);
        Switch activeSwitch = v.findViewById(R.id.activity_reminders_item_enabled);
