...
import faithworks.diabetesmonitoring.android.presenter.ExportPresenter;
...
public class MainActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener,
    ...
    private void openDonateIntent() {
        Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://www.diabetesmonitoring.org/donate/"));
    ...
    public void openSupportDialog() {
        ...
        builder.setItems(getResources().getStringArray(R.array.menu_support_options), new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                // Forum
                String url = "http://community.diabetesmonitoring.org/";
