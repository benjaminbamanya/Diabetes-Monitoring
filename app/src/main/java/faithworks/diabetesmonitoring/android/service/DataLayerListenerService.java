...
package faithworks.diabetesmonitoring.android.service;
...
public class DataLayerListenerService extends WearableListenerService {
    ...
    public void onMessageReceived(MessageEvent messageEvent) {
        ...
        if ("/GLUCOSIO_READING_WEAR".equals(messageEvent.getPath())) {
            ...
            finalString = new String(messageEvent.getData(), StandardCharsets.UTF_8);
    ...
    private void showNotification(String reading, String readingType) {
        ...
        // Gets an instance of the NotificationManager org.diabetesmonitoring.android.service
