...
public class PreferencesTest extends RobolectricTest {
    ...
    @Test
    public void ShouldReturnFalseAsDefault_WhenAskedIfLocaleWasCleared() {
        assertThat(preferences.isLocaleCleaned()).isFalse();
    }

    @Test
    public void ShouldReturnSavedValue_WhenLocaleIsClearedAsked() {
    ...
    @Test
    public void ShouldSaveLocaleIsCleaned_WhenAsked() {
