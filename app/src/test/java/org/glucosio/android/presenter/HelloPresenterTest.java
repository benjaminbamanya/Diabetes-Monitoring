...
public class HelloPresenterTest extends RobolectricTest {
    ...
    @Test
    public void ShouldSetUserId_WhenLoadDBHappens() {
    ...
    @Test
    public void ShouldAskForWarning_WhenAgeIsNegative() {
    ...
    @Test
    public void ShouldAskForWarning_WhenAgeIsZero() {
    ...
    @Test
    public void ShouldAskForWarning_WhenAgeIsAbove120() {
    ...
    @Test
    public void ShouldAskForWarning_WhenAgeIsNotNumber() {
    ...
    @Test
    public void ShouldAskForWarning_WhenAgeIsEmpty() {
    ...
    @Test
    public void ShouldAskForWarning_WhenAgeIsNull() {
    ...
    @Test
    public void ShouldPropagateAllValues_WhenSavingUser() {
    ...
    @Test
    public void ShouldPutADAValuesAsDefault_WhenSavingUser() {
