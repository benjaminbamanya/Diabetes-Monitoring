...
import faithworks.diabetesmonitoring.android.TestGlucosioApplication;
...
public class A1cCalculatorActivityTest extends RobolectricTest {
    ...
    @Test
    public void ShouldAskPresenterToCheckUnit_WhenCreated() {
    ...
    @Test
    public void ShouldBindViews_WhenCreated() {
    ...
    @Test
    public void ShouldSetMmolToMolAsUnit_WhenUserSettingsIsPercentage() {
    ...
    @Test
    public void NotifyPresenter_WhenGlucoseValueChanged() {
        String value = "2";
    ...
    @Test
    public void ReturnTrue_WhenKeyboardActionDone() {
        assertThat(activity.editorAction(null, EditorInfo.IME_ACTION_DONE, null)).isTrue();
    }

    @Test
    public void ReturnFalse_WhenKeyboardActionOther() {
