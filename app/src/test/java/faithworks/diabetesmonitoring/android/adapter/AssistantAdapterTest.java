...
public class AssistantAdapterTest extends RobolectricTest {
    ...
    @Test
    public void CallPresenter_WhenFeedbackAsked() {
    ...
    @Test
    public void CallPresenter_WhenExportAsked() {
    ...
    @Test
    public void CallPresenter_WhenA1CCalculatorAsked() {
    ...
    @Test
    public void CallPresenter_WhenAddReadingAsked() {
